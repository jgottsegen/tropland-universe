                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                        {[
                            ...
                            },
                            {
                                ...
                                title: 'The Kingdom',
                                body: 'Billions of views. Licensed by All-American Licensing. Major brand partnerships. The rainforest becomes the Digital Animal Kingdom.',
                            },
                        ].map((ch, i) => (
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
                            <div>
                                ...
                                <p className="font-display font-light text-lg text-ink/60 max-w-md">
                                    Billions of content views. Follow the journey on Instagram and Facebook.
                                </p>
                            </div>
