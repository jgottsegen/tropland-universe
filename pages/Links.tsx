...
<a href="https://www.instagram.com/troplanduniverse/"><svg viewBox="0 0 24 24" aria-hidden="true" style={{ color: '#a08bdd' }}><defs><linearGradient id="social-0" x2="1" y2="1"><stop stopColor="#a08bdd"/><stop offset="1" stopColor="#cf7ca3"/></linearGradient></defs><g stroke="url(#social-0)"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r=".7" fill="currentColor"/></g></svg><span>Instagram</span></a>
<a href="https://www.facebook.com/troplanduniverse/"><svg viewBox="0 0 24 24" aria-hidden="true" style={{ color: '#79a9f3' }}><defs><linearGradient id="social-1" x2="1" y2="1"><stop stopColor="#79a9f3"/><stop offset="1" stopColor="#88c7dd"/></linearGradient></defs><g stroke="url(#social-1)"><path d="M14 22v-9h3l.5-4H14V7c0-1.2.5-2 2-2h2V1.5c-.8-.2-1.8-.3-3-.3-3 0-5 1.8-5 5V9H7v4h3v9Z" fill="currentColor" stroke="none"/></g></svg><span>Facebook</span></a>
<a href="https://www.youtube.com/@TroplandClips" aria-label="YouTube: TroplandClips"><svg viewBox="0 0 24 24" aria-hidden="true" style={{ color: '#d78d83' }}><defs><linearGradient id="social-2" x2="1" y2="1"><stop stopColor="#d78d83"/><stop offset="1" stopColor="#d46b80"/></linearGradient></defs><g stroke="url(#social-2)"><rect x="2" y="5" width="20" height="14" rx="4"/><path d="m10 9 5 3-5 3Z" fill="currentColor" stroke="none"/></g></svg><span>YouTube</span></a>
</div></section>
